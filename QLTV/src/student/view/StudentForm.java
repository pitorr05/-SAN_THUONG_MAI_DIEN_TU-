...
public class StudentForm extends javax.swing.JFrame {
    ...
    private void comboboxCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboboxCategoryActionPerformed
        switch (comboboxCategory.getSelectedIndex()) {
            case 0 -> txtStudentId.setText("CT05" + (Student.ID + 1));
            case 1 -> txtStudentId.setText("AT17" + (Student.ID + 1));
            case 2 -> txtStudentId.setText("DT04" + (Student.ID + 1));
            default -> {
            }
        }
    ...
    private int takeId(String studentId) {
        String[] nameId = studentId.split("(AT17|CT05|DT04)");
