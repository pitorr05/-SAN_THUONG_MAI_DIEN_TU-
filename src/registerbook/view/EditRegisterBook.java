...
public class EditRegisterBook extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Mượn Trả", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtBookId, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                    .addComponent(spinnerAmount, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
                    .addComponent(txtAppointDate, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE))
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        if (studentId.isEmpty() || !bookId.isEmpty() || amount > 0 || appointDateText.isEmpty()) {
        ...
        if (appointDate.getTime() <= this.rb.getBorrowDate().getTime()) {
            JOptionPane.showMessageDialog(this, "Ngày hẹn trả phải lớn hơn ngày hiện thời");
            return;
        }
        RegisterBook rbtext = new RegisterBook(st.getStudentId(), book.getBookId());
        if (this.rb.getBookId().equalsIgnoreCase(bookId)
            ...
            int amountBook = rb.getAmountBook() + book.getAmount() - amount;
            ...
            if (!listRb.contains(rbtext)) {
                String bookidOld = this.rb.getBookId();
                String studentIdOld = this.rb.getStudentId();
                ...
                if (this.rb.getBookId().equalsIgnoreCase(bookidOld)) {
                    ...
                    Book bookOld = checkBookId(bookidOld);
                    int amountBookOld = bookOld.getAmount() + this.rb.getAmountBook();
                    bookOld.setAmount(amountBookOld);
                    DataBookFuctionImp dfBook = new DataBookFuctionImp();
                    dfBook.updateBookSQL(bookOld);
                    int amountBook = book.getAmount() - amount;
                    this.rb.setAmountBook(amount);
                    book.setAmount(amountBook);
                }
                DataBookFuctionImp dfBook = new DataBookFuctionImp();
